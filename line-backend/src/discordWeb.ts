...
<body>
  ...
  <main>
    <section id="studio" class="studio" aria-label="Discord announcement composer">
      <div class="intro">
...
async function loadChannels() {
  ...
  try {
    ...
    if (!result.channels.length) {
      ...
      option.value = ''; option.textContent = 'No allowed channels configured'; select.append(option);
      $('sendResult').textContent = 'Add allowed Discord channels in Cloudflare before sending.';
